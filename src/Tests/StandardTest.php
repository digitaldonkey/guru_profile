...
/**
 * @file
 * Contains \Drupal\guru_profile\Tests\GuruProfileTest.
 */

namespace Drupal\guru_profile\Tests;
...
/**
 * Tests guru_profile installation profile expectations.
 *
 * @group guru_profile
 */
class GuruProfileTest extends WebTestBase {

  use SchemaCheckTestTrait;

  protected $profile = 'guru_profile';
  ...
  /**
   * Tests guru_profile installation profile.
   */
  function testGuru() {
    $this->drupalGet('');
    ...
    // guru_profile profile modules are enabled.
    ...
    // Ensure that configuration from the guru_profile profile is not reused when
